...
When you create a contact or calendar event, your phone might give you the option of saving the data in the phone's internal storage, instead of in the cloud. While that's a nice feature to have, especially for the privacy-conscious, it also means you might have saved some important data locally if you didn't pay close attention. Before you wipey our phone, you should check to see if any of your contacts or calendar events aren't backed up to the cloud.
