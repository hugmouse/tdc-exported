...
Original: [www.ctvnews.ca](https://www.ctvnews.ca/sci-tech/space-shipment-launched-with-sports-car-parts-cookie-oven-1.4667374)
...
Northrop Grumman is now controlling two Cygnus capsules in orbit, a first for the Virginia-based company. Named for the swan constellation, the Cygnus launched last spring is flying free of the 250-mile-high (400-kilometre-high) space station, after completing its grocery run. It will be directed to a fiery re-entry sometime in the near future, taking station trash down with it, according to company officials.
